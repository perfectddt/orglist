...
当前安装包版本：`1.7.0`（versionCode 21）  
Android 工程源码：`1.8.0`（预备 versionCode 22，尚未生成 APK）  
最低系统：Android 8.0（API 26）  
安装包 SHA-256：

```text
0f5bbf07a0b9716ed2b9537a573d701006de69dfb291ee0191c7b6d4f64f4e5b
```
...
- 按本次开发要求未运行 Gradle、未生成或覆盖 APK，以上功能需以后构建 1.8.0 APK 才会出现在安装包中。
