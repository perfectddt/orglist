/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.15.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.15.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "应用筛选不再覆盖窗口自己的视图；布局按钮与折叠尺寸持久保存" },
    activate(api) {
