/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.6.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.6.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "折叠前后各自独立的位置与大小（视为两个窗口）；悬停注释仅布局模式；按钮节点、装饰窗口、智能清单竖列横排、布局历史导出" },
    activate(api) {
