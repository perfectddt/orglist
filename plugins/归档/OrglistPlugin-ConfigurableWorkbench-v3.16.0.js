/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.16.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.16.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "应用当前筛选只更新条件、不改变窗口自己的视图；筛选条件端到端生效" },
    activate(api) {
