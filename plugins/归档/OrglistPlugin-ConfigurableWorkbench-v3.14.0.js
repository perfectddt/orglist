/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.14.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.14.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "折叠宽高最小 0.1；折叠状态可显示自定义文字并可横放/竖放；应用筛选支持四象限等视图" },
    activate(api) {
      ...
      function taskMarkup(node) {
        const view = node.filters?.view && viewLabels[node.filters.view] ? node.filters.view : node.view;
