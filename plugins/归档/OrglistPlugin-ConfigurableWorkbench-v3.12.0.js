/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.12.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.12.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "布局历史与默认布局支持导入导出 JSON 备份" },
    activate(api) {
