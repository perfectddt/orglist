/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.19.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.19.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "修复布局按钮浮动状态持久化、详情按选中自动展开、四象限空栏高度" },
    activate(api) {
      ...
      function taskQueryOptions(node, view) {
        ...
        if (filters.status && filters.status !== "ALL") { if (filters.status === "OPEN") options.completed = false; else options.status = [String(filters.status)]; }
