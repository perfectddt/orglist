/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.21.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.21.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "折叠高度上限调整为 15 行" },
    activate(api) {
