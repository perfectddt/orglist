/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"4.1.2","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  const css = `
    ...
    @media(max-width:760px){.owb-root{padding:7px}.owb-mode-use{display:flex;flex-direction:column;gap:8px}.owb-mode-use>.owb-node:not(.floating){flex:0 0 auto;min-height:360px}.owb-mode-use>[data-owb-node="container-toolbar"]{min-height:108px!important}.owb-mode-use>.owb-core-layout.floating{width:88px!important;height:46px!important}.owb-mode-use .owb-container-body{display:flex;flex-direction:column;gap:7px}.owb-mode-use [data-owb-node="container-toolbar"]>.owb-node-inner>.owb-node-body>.owb-container-body{align-content:flex-start;flex-direction:row;flex-wrap:wrap}.owb-mode-use .owb-container-body>.owb-node:not(.floating){flex:0 0 auto;min-height:180px}.owb-mode-use .owb-container-body>.owb-core-button:not(.floating){flex:1 1 100%;min-height:46px}.owb-mode-use [data-owb-node="container-toolbar"] .owb-core-search{flex:1 1 240px;min-height:46px}.owb-mode-use [data-owb-node="container-toolbar"] .owb-core-searchHelp{flex:0 0 88px;min-height:46px}.owb-mode-use [data-owb-node="container-toolbar"] :is(.owb-core-back,.owb-core-theme,.owb-core-batch,.owb-core-add,.owb-core-menu){flex:0 0 46px!important;width:46px!important;min-height:46px}.owb-mode-use .owb-container-body>.owb-core-smart,.owb-mode-use .owb-container-body>.owb-core-files,.owb-mode-use .owb-container-body>.owb-core-mainList{min-height:360px}.owb-mode-use .owb-container-body>.owb-core-detail{min-height:430px}.owb-mode-use .owb-node.floating{position:fixed!important;right:8px!important;bottom:8px!important;left:auto!important;top:auto!important;max-width:calc(100vw - 16px)}.owb-mode-use .owb-node.floating:not(.collapsed){width:calc(100vw - 16px)!important;height:min(72vh,620px)!important}.owb-mode-use .owb-node.floating.collapsed{width:min(180px,46vw)!important;height:46px!important}.owb-mode-use .owb-node.floating.owb-core-layout{width:88px!important;height:46px!important}.owb-mode-use .owb-resize{display:none!important}.owb-mode-use .owb-node-head{cursor:default}.owb-year-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.owb-month-grid{min-width:620px}.owb-form{grid-template-columns:1fr}.owb-field.wide,.owb-checks,.owb-form-actions{grid-column:1}.owb-checks{grid-template-columns:1fr}.owb-config{right:8px;bottom:8px;width:calc(100vw - 16px);max-height:calc(100vh - 16px)}}
    ...
    @media(max-width:760px){.owb-mode-use.owb-canvas,.owb-mode-use .owb-container-body{height:auto!important;min-height:0!important}.owb-mode-use.owb-canvas .owb-node:not(.floating),.owb-mode-use .owb-container-body>.owb-node:not(.floating){position:static!important;right:auto!important;bottom:auto!important;left:auto!important;top:auto!important;width:auto!important;height:auto!important}}
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "4.1.2", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "手机窄屏布局模式恢复触摸拖动与缩放，使用模式继续自动堆叠" },
    activate(api) {
      ...
      const exportHistory = () => {
        const payload = { app: "orglist.configurable-workbench", version: "4.1.2", exportedAt: new Date().toISOString(), defaultLayout: api.getSetting("defaultLayout", null), layoutHistory: api.getSetting("layoutHistory", []), config: { schema: 4, mode: config.mode, nodes: config.nodes } };
