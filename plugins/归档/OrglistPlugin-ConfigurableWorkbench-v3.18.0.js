/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.18.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.18.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "主清单应用当前筛选可双向切换视图（含日历）；任务窗口保持自身视图" },
    activate(api) {
      ...
      function taskMarkup(node) {
        const tasks = api.queryTasks(taskQueryOptions(node, node.view));
