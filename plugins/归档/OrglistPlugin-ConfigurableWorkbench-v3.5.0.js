/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.5.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.5.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "悬停注释仅布局模式显示；新增按钮节点、装饰文字/图案窗口、智能清单竖排、布局历史导出" },
    activate(api) {
