/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.9.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.9.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "新增逐节点“显示标题”开关，节点头部不再出现灰色类别文字" },
    activate(api) {
