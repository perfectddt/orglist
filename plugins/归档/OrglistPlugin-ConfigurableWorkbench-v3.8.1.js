/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.8.1","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.8.1", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "装饰节点不再出现通用标签；日历条目按状态着色，与主清单/四象限配色一致" },
    activate(api) {
