/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.13.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.13.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "内容缩放对所有窗口可用；应用当前筛选捕获文件/智能清单/自定义清单/搜索等全部条件" },
    activate(api) {
      ...
      function taskQueryOptions(node) {
        ...
        if (filters.view && viewLabels[filters.view] && !wide) options.view = filters.view;
      ...
      function renderWorkspace() {
        ...
        canvas.querySelectorAll("[data-apply-filters]").forEach((button) => button.onclick = () => {
          ...
          const view = document.querySelector("#nav [data-view].active")?.dataset?.view || lastSummary.view || "";
