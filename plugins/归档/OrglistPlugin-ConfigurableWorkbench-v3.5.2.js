/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.5.2","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  function normalizeNode(value, index, ids) {
    ...
    node.anchor = ["top-left", "top", "top-right", "right", "bottom-right", "bottom", "bottom-left", "left", "center"].includes(value?.anchor) ? value.anchor : "top-left";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.5.2", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "悬停注释仅布局模式显示；折叠浮窗可自定义折叠锚点；按钮节点、装饰文字/图案、智能清单一列列横排、布局历史导出" },
    activate(api) {
