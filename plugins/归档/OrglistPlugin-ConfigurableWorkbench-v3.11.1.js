/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.11.1","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.11.1", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "中间主清单可通过表单添加多个" },
    activate(api) {
