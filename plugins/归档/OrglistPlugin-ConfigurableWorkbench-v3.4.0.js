/* @orglist-plugin {"id":"orglist.configurable-workbench","name":"空白画布工作台","version":"3.4.0","type":"layout","hostApi":2} */
(function () {
  "use strict";
  ...
  host.register({
    manifest: { id: pluginId, name: "空白画布工作台", version: "3.4.0", type: "layout", hostApi: 2, platforms: ["windows", "android"], description: "布局面板可拖动；默认布局与历史收进面板顶部按钮；布局模式隐藏节点标题、悬停显示注释" },
    activate(api) {
